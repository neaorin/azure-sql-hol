# Always Encrypted: Protect sensitive data in SQL Database 
...
![Always Encrypted Diagram](https://social.technet.microsoft.com/wiki/cfs-filesystemfile.ashx/__key/communityserver-wikis-components-files/00-00-00-00-05/1724745145.1.jpg)
...
1. Expand **Databases** > **(your database)** > **Tables**.
2. Right-click the **Patients** table and select **Encrypt Columns** to open the Always Encrypted wizard:
   
    ![Encrypt columns](https://docs.microsoft.com/en-us/azure/sql-database/media/sql-database-always-encrypted/encrypt-columns.png)
...
![Encrypt columns](https://docs.microsoft.com/en-us/azure/sql-database/media/sql-database-always-encrypted/column-selection.png)
...
![Master key configuration](https://docs.microsoft.com/en-us/azure/sql-database/media/sql-database-always-encrypted/master-key-configuration.png)
...
![Summary](https://docs.microsoft.com/en-us/azure/sql-database/media/sql-database-always-encrypted/summary.png)
...
You can verify the creation of the keys in SSMS by going to **(your database)** > **Security** > **Always Encrypted Keys**. You can now see the new keys that the wizard generated for you.
...
![New console application](https://docs.microsoft.com/en-us/azure/sql-database/media/sql-database-always-encrypted/console-app.png)
...
Run the app to see Always Encrypted in action.
    ...
    class Program
    {
        // Update this line with your database connection string from the Azure portal.
...
You can see that the encrypted columns do not contain any plaintext data.
   ...
   ![New console application](https://docs.microsoft.com/en-us/azure/sql-database/media/sql-database-always-encrypted/ssms-encrypted.png)
...
3. Click **Additional Connection Parameters** and type **Column Encryption Setting=enabled**.
    ...
    ![New console application](https://docs.microsoft.com/en-us/azure/sql-database/media/sql-database-always-encrypted/ssms-connection-parameter.png)
4. Run the following query on the database.
    ...
    ![New console application](https://docs.microsoft.com/en-us/azure/sql-database/media/sql-database-always-encrypted/ssms-plaintext.png)
