...
4. Click **Stop Replication**.
    ...
    ![Remove secondary](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/master/articles/sql-database/media/sql-database-geo-replication-portal/remove-secondary.png)
