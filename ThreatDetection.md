...
Threat Detection is part of the [SQL Advanced Threat Protection](https://docs.microsoft.com/en-us/azure/sql-database/sql-advanced-threat-protection) (ATP) offering, which is a unified package for advanced SQL security capabilities. Threat Detection can be accessed and managed via the central SQL ATP portal.
...
For a full investigation experience, it is recommended to enable [SQL Database Auditing](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-auditing), which writes database events to an audit log in your Azure storage account.  
...
3. On the **Advanced Threat Protection** configuration page:
   ...
   ![Set up threat detection](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/master/articles/sql-database/media/sql-database-threat-detection/set_up_threat_detection.png)
...
![Anomalous activity report](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/master/articles/sql-database/media/sql-database-threat-detection/anomalous_activity_report.png)
...
1. Click the **View recent SQL alerts** link in the email to launch the Azure portal and show the Azure Security Center alerts page, which provides an overview of active threats detected on the SQL database.
   ...
   ![Activty threats](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/master/articles/sql-database/media/sql-database-threat-detection/active_threats.png)
...
2. Click a specific alert to get additional details and actions for investigating this threat and remediating future threats.
   ...
   ![Specific alert](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/master/articles/sql-database/media/sql-database-threat-detection/specific_alert.png)
...
Click **Threat detection alert** to launch the Azure Security Center alerts page and get an overview of active SQL threats detected on the database.
   ...
   ![Threat detection alert](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/master/articles/sql-database/media/sql-database-threat-detection/threat_detection_alert.png)
   
   ![Threat detection alert2](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/master/articles/sql-database/media/sql-database-threat-detection/threat_detection_alert_atp.png)
